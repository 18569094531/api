...
<head>
    ...
    <script src="./MinPHP/res/respond.min.js"></script> url(image.jpg);
    <![endif]-->
</head>
...
<div class="container-fluid" style="background:white;height:100%;">
    <div class="row" style="height:100%;">
        ...
        <span style="position: relative;top:-3px;">小农人 API<span style="font-size:12px;position:relative;top:-13px;">&nbsp;<?php echo C('version->no')?></span>
                </a>
                </span>
            </div>
            <?php
