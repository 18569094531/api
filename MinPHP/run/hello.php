...
<div style="font-size:18px;">
    <div class="info" style="font-size:14px;">
      <span style="font-size:30px;" class="glyphicon glyphicon-grain" aria-hidden="true"></span> <span style="font-size:16px;">欢迎使用小农人文档管理工具 <?php echo C('version->no').'版';?></span><br>
